...
static const uint8_t LED_SYM_CHECK[5] = {0x00, 0x01, 0x02, 0x14, 0x08};
static const uint8_t LED_SYM_CROSS[5] = {0x11, 0x0A, 0x04, 0x0A, 0x11};
static const uint8_t LED_SYM_HEART[5] = {0x0A, 0x1F, 0x1F, 0x0E, 0x04};
...
static const uint8_t LED_SYM_FULL[5] = {0x1F, 0x1F, 0x1F, 0x1F, 0x1F};
static const uint8_t LED_SYM_EMPTY[5] = {0x00, 0x00, 0x00, 0x00, 0x00};
...
/**
 * ASCII 文字からフォントパターンを取得する
 * @param c  ASCII 文字
 * @return フォントパターン (未定義文字は nullptr)
 */
static inline const uint8_t *led_font_get(char c) {
    static const uint8_t *const s_digits[] = {
        LED_CHAR_0,
        LED_CHAR_1,
        LED_CHAR_2,
        LED_CHAR_3,
    ...
    static const uint8_t *const s_alpha[] = {
